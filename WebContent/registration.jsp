...
%>
<title><%=lang.getString("login_page.h2.loginM")%></title>
</head>
<body>
					...
					<form class="col s12" action="register" method="post">
						<div class="row">
							<div class="input-field col s12">
								<input placeholder="<%=lang.getString("reg_page.label.uname")%>" type="text" name="username"
									required="required" />
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
								<input placeholder="<%=lang.getString("reg_page.label.email")%>" type="text" name="email"
									required="required" />
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
								<input placeholder="<%=lang.getString("reg_page.label.password")%>" type="password" name="password"
									required="required" />
							</div>
						</div>
						<div class="row">
							<div class="input-field col s12">
								<input class="waves-effect waves-light btn" type="submit"
									value=<%=lang.getString("reg_page.button.reg")%> />
							</div>
						</div>
					</form>
				</div>
